...
// Uusi funktio kuvien esilataamista varten
...
// Päivitetty loadQuestion-funktio
function loadQuestion() {
    const question = currentQuestions[currentQuestion];
    
    // Esiladataan kaikki kysymyksen kuvat
    preloadImages([
        question.mainImage,
        ...
        // Kuvat on nyt esiladattu, asetetaan ne näkyviin
...
function restartGame() {   
    ...
    document.getElementById('question-container').innerHTML = `
        ...
        <img id="next-arrow" src="nuoli.avif" onclick="nextQuestion()">
    `;
